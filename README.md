...
A random map of floor and wall tiles are generated each time the editor is started, or after a level is saved, you can also regenerate the map via the Randomize Map menu.<br>
...
<img src="docs/SaveANewlyMadeMap.png" width="300"><br>
